...
export const get401Response = ({ json, res }: { res: Response; json?: AnyRecord }) => {
  return getResponse({ res, status: 401, json });
};

export const get500Response = ({ json, res }: { res: Response; json?: AnyRecord }) => {
  return getResponse({ res, status: 500, json });
};

export const get422Response = ({ json, res }: { res: Response; json?: AnyRecord }) => {
  return getResponse({ res, status: 422, json });
};

export const get400Response = ({ json, res }: { res: Response; json?: AnyRecord }) => {
  return getResponse({ res, status: 400, json });
};

export const get404Response = ({ json, res }: { res: Response; json?: AnyRecord }) => {
  return getResponse({ res, status: 404, json });
};

export const get200Response = ({ json, res }: { res: Response; json?: AnyRecord }) => {
  return getResponse({ res, status: 200, json });
};

export const get201Response = ({ json, res }: { res: Response; json?: AnyRecord }) => {
...
export const getBlogNotFoundResponse = ({ res }: { res: Response }) => {
  return get404Response({ res, json: { message: 'No existe este blog.' } });
};
